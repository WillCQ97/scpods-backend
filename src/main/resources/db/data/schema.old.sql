...
CREATE TABLE public.tb_centros (
    ...
    CONSTRAINT tb_centros_fk_unidades FOREIGN KEY (id_unidade) REFERENCES public.tb_unidades(id)
);
...
CREATE TABLE public.tb_coordenadores (
    ...
    CONSTRAINT tb_coordenadores_fk_vinculo FOREIGN KEY (id_vinculo) REFERENCES public.tb_tipo_vinculo(id)
);
...
CREATE TABLE public.tb_estruturas_organizacionais (
    ...
    CONSTRAINT tb_estruturas_organizacionais_fk_centros FOREIGN KEY (id_centro) REFERENCES public.tb_centros(id),
    CONSTRAINT tb_estruturas_organizacionais_fk_unidades FOREIGN KEY (id_unidade) REFERENCES public.tb_unidades(id)
);
...
CREATE TABLE public.tb_acoes (
    ...
    CONSTRAINT tb_acoes_fk_estruturas_organizacionais FOREIGN KEY (id_estrutura_organizacional) REFERENCES public.tb_estruturas_organizacionais(id),
