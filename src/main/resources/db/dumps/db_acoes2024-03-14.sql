...
--
-- Name: TABLE tb_acoes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tb_acoes IS 'Projetos realizados pela e na UFES';
...
--
-- Name: TABLE tb_coordenadores; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tb_coordenadores IS 'Coordenadores dos projetos';
...
COMMENT ON TABLE public.tb_locais IS 'Tabela contendo pontos gerados para as estruturas prediais dos campi da UFES com base nos jsons da equipe de prodesing (https://prodesign.ufes.br/)';
...
--
-- Name: TABLE tb_lotacoes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tb_lotacoes IS 'Consideração das principais estruturas organizacionais da UFES: os centros, o hucam e reitoria';
...
--
-- Name: TABLE tb_metas; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tb_metas IS 'Metas pertencentes aos Objetivos de Desenvolvimento Sustentável';
...
--
-- Name: TABLE tb_objetivos; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tb_objetivos IS 'Objetivos de Desenvolvimento Sustentável definido pela ONU para a Agenda 2030';
...
COMMENT ON TABLE public.tb_unidades IS 'Unidades da UFES, considerando as instalações físicas, associadas a algum campus';
...
1	3.3	3	Máscaras Solidárias em Alegre	Produção de aproximadamente 5 mil máscaras a partir de materiais recomendados pelo Ministério da Saúde para posterior distribuição no município.	2021-01-01	\N	t	2023-01-12	8	2
2	8.2	4	Desenvolvimento do Polo de Fruticultura da Região do Caparaó	Visa contribuir para a diversificação da produção agrícola gerando novas fontes de renda, e consequentemente, melhoria socioeconômica da população envolvida.	2021-01-01	\N	t	2023-01-12	22	1
...
4	3.3	2	Produção de álcool 70 em solução e gel para o campus de Alegre da UFES e para a secretaria municipal de saúde	Realiza a produção e doação de álcool para o combate a pandemia de COVID-19 na universidade e no município.	2021-01-01	\N	t	2023-01-12	8	2
5	3.3	16	GEOCOVID-ES: Monitoramento da Covid-19 através de mapas diários automatizados	Geração de Mapas Diários de Risco de Contaminação por COVID-19 para o Espírito Santo e a Incerteza Associada ao Risco	2020-06-01	2021-06-01	f	2023-11-09	9	1
6	3.3	17	Lorem Ipsum	Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempore assumenda eius, quisquam perspiciatis est, sit voluptatibus facilis aperiam omnis sint magni earum dolore repellendus blanditiis nostrum quos incidunt.	2020-06-01	2021-06-01	f	2023-11-10	9	1
7	6.1	19	LOREM IPSUM II	Lorem Ipsum dolor siamet.	2023-11-19	\N	f	2023-11-19	19	2
\.
...
2	Campus de Goiabeiras	GOIABEIRAS
1	Campus Alegre	ALEGRE
3	Campus Maruípe	MARUIPE
4	Campus São Mateus	SAO_MATEUS
\.
...
SELECT pg_catalog.setval('public.tb_acoes_id_seq', 7, true);
