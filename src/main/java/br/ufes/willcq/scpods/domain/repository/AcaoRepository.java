...
public interface AcaoRepository extends ListCrudRepository<Acao, Long> {
    ...
    @Query( value = """
            ...
            WHERE
                ...
                and (lower(lt.descricao) like concat('%', trim(lower(:nomeLotacao)),'%') or :nomeLotacao is null)
                ...
                and (a.aceito = :aceito)
            """ )
    List<AcaoSearchDTO> search( String titulo, CampusEnum campus, String nomeCoordenador, String nomeLocal, String nomeLotacao, String nomeUnidade, String codigoObjetivo, String codigoUnidade, boolean aceito );
