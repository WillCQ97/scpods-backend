...
public interface AcaoRepository extends ListCrudRepository<Acao, Long> {
    ...
    @Query( value = """
            ...
            WHERE
                ...
                and (a.aceito = :aceito)
            """ )
    List<AcaoSearchDTO> search( String titulo, CampusEnum campus, String nomeCoordenador, String nomeLocal, String siglaLotacao, String nomeUnidade, String codigoObjetivo, String codigoUnidade, boolean aceito );
