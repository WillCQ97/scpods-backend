...
ALTER SEQUENCE public.tb_vinculo_organizacional_id_seq OWNED BY public.tb_lotacoes.id;
...
ALTER TABLE ONLY public.tb_lotacoes ALTER COLUMN id SET DEFAULT nextval('public.tb_vinculo_organizacional_id_seq'::regclass);
...
COPY public.tb_acoes (id, id_meta, id_coordenador, titulo, descricao, dt_inicio, dt_encerramento, fl_aceito, dt_cadastro, id_lotacao) FROM stdin;
4	3.3	3	Máscaras Solidárias em Alegre	Produção de aproximadamente 5 mil máscaras a partir de materiais recomendados pelo Ministério da Saúde para posterior distribuição no município.	2021-01-01	\N	t	2023-01-12	3
5	8.2	4	Desenvolvimento do Polo de Fruticultura da Região do Caparaó	Visa contribuir para a diversificação da produção agrícola gerando novas fontes de renda, e consequentemente, melhoria socioeconômica da população envolvida.	2021-01-01	\N	t	2023-01-12	7
...
3	3.3	2	Produção de álcool 70 em solução e gel para o campus de Alegre da UFES e para a secretaria municipal de saúde	Realiza a produção e doação de álcool para o combate a pandemia de COVID-19 na universidade e no município.	2021-01-01	\N	t	2023-01-12	3
9	3.3	16	GEOCOVID-ES: Monitoramento da Covid-19 através de mapas diários automatizados	Geração de Mapas Diários de Risco de Contaminação por COVID-19 para o Espírito Santo e a Incerteza Associada ao Risco	2020-06-01	2021-06-01	f	2023-11-09	4
10	3.3	17	Lorem Ipsum	Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempore assumenda eius, quisquam perspiciatis est, sit voluptatibus facilis aperiam omnis sint magni earum dolore repellendus blanditiis nostrum quos incidunt.	2020-06-01	2021-06-01	f	2023-11-10	4
\.
...
8	Fabricia Benda de Oliveira	PROFESSOR	\N	fabricia.oliveira@ufes.br
13	Fabricia Benda de Oliveira	PROFESSOR	\N	fabricia.oliveira@ufes.br
14	Fabricia Benda de Oliveira	PROFESSOR	\N	fabricia.oliveira@ufes.br
15	Fabricia Benda de Oliveira	PROFESSOR	\N	fabricia.oliveira@ufes.br
...
COPY public.tb_lotacoes (id, id_centro, nome, localizacao, id_unidade) FROM stdin;
...
SELECT pg_catalog.setval('public.tb_acoes_id_seq', 10, true);
...
--
-- Name: tb_lotacoes tb_estrutura_organizacional_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tb_lotacoes tb_estruturas_organizacionais_fk_centros; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tb_lotacoes tb_estruturas_organizacionais_fk_unidades; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
